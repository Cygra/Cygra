...
|:-----------|:------------|:-------|
| [hand-gesture-whiteboard](https://github.com/Cygra/hand-gesture-whiteboard) | Using Mediapipe and Nextjs to detect hand gesture and draw lines like a whiteboard. | <kbd>mediapipe</kbd> <kbd>nextjs</kbd> <kbd>machinelearning</kbd> <kbd>mediapipe-hand</kbd> <kbd>whiteboard</kbd> |
...
|:-----------|:------------|:-------|--------:|
| [hand-gesture-whiteboard](https://github.com/Cygra/hand-gesture-whiteboard) | Using Mediapipe and Nextjs to detect hand gesture and draw lines like a whiteboard. | <kbd>mediapipe</kbd> <kbd>nextjs</kbd> <kbd>machinelearning</kbd> <kbd>mediapipe-hand</kbd> <kbd>whiteboard</kbd> | **35** |
