...
| [minimax-usage](https://github.com/Cygra/minimax-usage) | 查询 MiniMax 模型 API 使用量的 Claude Code Skill。 |  |
...
| [profile-calendar](https://github.com/Cygra/profile-calendar) | Put the current date on your github profile!  |  | **12** |
